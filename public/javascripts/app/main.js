 ...
 */ (function ($) {
    ...
    $(".scroller-up").live("click", function () {
        ...
        if (scrollerContentHolderHeight > parentHeight) {
            if ((scrollerContentHolderTop - 145) > -(scrollerContentHolderHeight)) $(this).siblings().find(".scrollerContentHolder").stop().animate({
                "top": "-=85px"
            }, "slow");
        }
    });
    ...
    $(".scroller-down").live("click", function () {
        ...
        //alert(scrollerContentHolderTop+" - "+scrollerContentHolderHeight);
        if (scrollerContentHolderHeight > parentHeight) {
            if (scrollerContentHolderTop < 0) $(this).siblings().find(".scrollerContentHolder").stop().animate({
                "top": "+=85px"
            }, "slow");
        }
    });
